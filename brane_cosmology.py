...
axes[0, 0].set_title(f'Brane Position along $Y_{1}$ for $f_1 = {h_1:.3f}$')
...
axes[0, 1].set_title(f'Brane Position along $Y_{1}$ for $f_2 = {h_2:.3f}$')
...
axes[1, 0].set_title(f'Brane Position along $Y_{2}$ for $f_1 = {h_1:.3f}$')
...
axes[1, 1].set_title(f'Brane Position along $Y_{2}$ for $f_2 = {h_2:.3f}$')
...
axes[0, 0].set_title(f'Light Ray Position along $x^{1}$ for $f_1 = {h_1:.3f}$')
axes[0, 0].legend(['Euler', 'RK4'], loc = 'best', ncol = 1)
...
axes[0, 1].set_title(f'Light Ray Position along $x^{1}$ for $f_2 = {h_2:.3f}$')
axes[0, 1].legend(['Euler', 'RK4'], loc = 'best', ncol = 1)
...
axes[1, 0].set_title(f'Light Ray Position along $x^{4}$ for $f_1 = {h_1:.3f}$')
axes[1, 0].legend(['Euler', 'RK4'], loc = 'best', ncol = 1)
...
axes[1, 1].set_title(f'Light Ray Position along $x^{4}$ for $f_2 = {h_2:.3f}$')
axes[1, 1].legend(['Euler', 'RK4'], loc = 'best', ncol = 1)
...
axes[2, 0].set_title(f'Light Ray Position along $x^{5}$ for $f_1 = {h_1:.3f}$')
...
axes[2, 1].set_title(f'Light Ray Position along $x^{5}$ for $f_2 = {h_2:.3f}$')
